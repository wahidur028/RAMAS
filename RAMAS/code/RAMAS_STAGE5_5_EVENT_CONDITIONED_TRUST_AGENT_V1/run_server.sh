...
PACKAGE_ROOT="${PROJECT_ROOT}/RAMAS_STAGE5_5_EVENT_CONDITIONED_TRUST_AGENT_V1"
PROVIDER="${RAMAS_PROVIDER:-ollama}"
MODEL="${RAMAS_MODEL:-qwen3-coder:30b}"
TIMESTAMP="$(date -u +%Y%m%dT%H%M%SZ)"
RUN_ROOT="${PROJECT_ROOT}/EXPERIMENT_BRANCHES/RAMAS_STAGE5_5_EVENT_CONDITIONED_TRUST_AGENT_V1/artifacts/${TIMESTAMP}"

echo "RAMAS_PROJECT_ROOT=${PROJECT_ROOT}"
echo "RAMAS_STAGE5_5_PACKAGE=${PACKAGE_ROOT}"
