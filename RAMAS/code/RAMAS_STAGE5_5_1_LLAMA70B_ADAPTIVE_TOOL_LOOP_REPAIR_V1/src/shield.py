...
def evaluate_shield(
    ...
    *,
    ...
    if active_intervention and operator not in ("KEEP", "ROLLBACK"):
        reasons.append("ACTIVE_INTERVENTION_EXISTS")
    if operator == "ROLLBACK" and not active_intervention:
        reasons.append("ROLLBACK_WITHOUT_ACTIVE_INTERVENTION")
    ...
    if operator != "KEEP" and movement <= 1e-12:
        reasons.append("NO_TRUST_CHANGE_FOR_INTERVENTION")
